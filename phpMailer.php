    ...
    if(isset($_POST["vpassNo"])) {
        ...
        $mail->addAddress($deptMgr ."@funai-cebu.com.ph", "Approver");
            ...
            $whole_message = "$mail->Body
                        ...
                        <p>Click <a href='http://10.104.36.24/basti/visitorpass/index.php?vpassNo=$vpassNo&status=$status'
        ...
        $mail->addAddress($deptMgr ."@funai-cebu.com.ph", "Security Office");
            ...
            $whole_message = "$mail->Body
                        ...
                        <p>Click <a href='http://10.104.36.24/basti/visitorpass/index.php?vpassNo=$vpassNo&status=$status' class='view-link'
